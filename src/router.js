    ...
    return (
        <Routes>
            ...
            <Route element={<MasterLayout />}>
                ...
                <Route path={ROUTERS.USER.CUSTOMERSUPPORT} element={<CustomerSupportPage/>} />
            </Route>
            ...
            <Route path={ROUTERS.USER.GOOGLE_CALLBACK} element={<GoogleCallbackPage />} />
            
    
            {/* GROUP 3 — EMPLOYER dùng EmployerMasterLayout */}
      <Route element={<EmployerMasterLayout />}>
        <Route path={ROUTERS.EMPLOYER.DASHBOARD} element={<EmployerDashboardPage />} />
        <Route path={ROUTERS.EMPLOYER.POST_JOB} element={<EmployerPostJobPage />} />
        <Route path={ROUTERS.EMPLOYER.VIEWAPPLICATIONS} element={<EmployerViewApplicationsPage />} />
        <Route path={ROUTERS.EMPLOYER.CUSTOMERSUPPORT} element={<EmployerCustomerSupportPage />} />
        <Route path={ROUTERS.EMPLOYER.APPLICATIONS} element={<EmployerApplications />} />
      </Route>
    </Routes>
